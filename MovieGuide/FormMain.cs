...
namespace MovieGuide
{
    ...
    public partial class FormMain : Form
    {
        ...
        private void FormMain_Shown(object sender, EventArgs e)
        {
            ...
            {
                MiniMessageBox.Show(this, "Welcome! This is the first time running MovieGuide. Please read\nthe information in the About dialog. This will help you setup your\nmovie layout. When complete, go to File->Settings to enter the\nroot folder of all your movies.", "Initial MovieGuide Startup");
                return;
            }
        ...
        private void SetViewMenu(ViewType v)
        {
            ...
            for(int i=0; i<menuitems.Length; i++)
            {
                if (i==(int)v)
                {
                    ...
                    menuitems[i].Image = global::MovieGuide.Properties.Resources.CheckMark16;
                }
                else
                {
